...
Author = Tirth Dineshkumar Vyas
Last Updatated on = December 18
Description = Code to test on a single image and detect bottles wiht their position and display the result in a two dimentional array where 'x' represents a present bottle 
              and '0' represnets a empty slot.
=====================================
"""
...
print("Using IP: 192.168.2.115, Port: 3000, Keyword:'posts'")
os.system("json-server --host 192.168.2.115 data.json --port 3000")
